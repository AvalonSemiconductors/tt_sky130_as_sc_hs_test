...
class Project:
    ...
    def harden(self):
        ...
        if self.args.orfs:
            ...
            setup_cmd = f"python -m openlane.setup run --pdk-root {arg_pdk_root} --docker-no-tty --dockerized --run-tag wokwi --force-run-dir runs/wokwi {arg_progress} src/config_merged.json"
